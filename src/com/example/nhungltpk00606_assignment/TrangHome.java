...
public class TrangHome extends Activity {
	String[] menutitles;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_tranghome);
...
//		Fragment fragment = null;
		switch (position) {
		case 0:
			Intent intent=new Intent(getApplicationContext(),Hello_fm.class);
			startActivity(intent);
			break;
		case 1:
			Intent intent1=new Intent(getApplicationContext(),GioiThieu_fm.class);
			startActivity(intent1);
			break;
		case 2:
			Intent intent2=new Intent(getApplicationContext(),GiaiTri_fm.class);
